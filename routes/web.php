...
Route::middleware(['auth', 'admin', 'role:admin,supervisor', 'tenancy.session'])->group(function () {
    ...
    Route::get ('/admin/visitantes/stats',                    [AdminController::class,      'visitantesStats'])->name('admin.visitantes.stats');
    ...
    Route::get   ('/admin/empleados/{id}/imagen-perfil',        [ApiEmpleadoController::class, 'getImagenPerfil'])->where('id', '[0-9]+');
    Route::post  ('/admin/empleados/{id}/imagen-perfil',        [ApiEmpleadoController::class, 'storeImagenPerfil'])->where('id', '[0-9]+');
    Route::delete('/admin/empleados/{id}/imagen-perfil',        [ApiEmpleadoController::class, 'destroyImagenPerfil'])->where('id', '[0-9]+');
    ...
    Route::get   ('/admin/notificaciones/historial',                    [AdminController::class, 'notificacionesHistorial']);
    Route::get   ('/admin/notificaciones/historial/{id}/destinatarios', [AdminController::class, 'notificacionesDestinatarios']);
