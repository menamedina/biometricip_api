...
#pEmpleado + .select2-container { width: 100% !important; }
#pEmpleado + .select2-container .select2-selection--single { height: 38px; border-color: #dee2e6; border-radius: .375rem; }
#pEmpleado + .select2-container .select2-selection__rendered { line-height: 36px; font-size: 1rem; }
#pEmpleado + .select2-container .select2-selection__arrow { height: 36px; }
